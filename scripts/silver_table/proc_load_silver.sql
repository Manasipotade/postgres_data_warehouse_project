...
DECLARE 
    ...
    batch_end TIMESTAMP;
    table_start_time_time TIMESTAMP;
...
BEGIN
    ...
    ---------------------------
        ...
        table_start_time_time := clock_timestamp();
        ...
        RAISE NOTICE 'Loaded silver.crm_cust_info in % seconds', EXTRACT(SECOND FROM table_end_time - table_start_time_time);
        ...
        table_end_time := clock_timestamp();
        RAISE NOTICE 'Loaded silver.crm_prd_info in % seconds', EXTRACT(SECOND FROM table_end_time - table_start_time_time);
        ...
        table_end_time := clock_timestamp();
        RAISE NOTICE '  Loaded silver.crm_sales_details in % seconds', EXTRACT(SECOND FROM table_end_time - table_start_time_time);
        ...
        table_end_time := clock_timestamp();
        RAISE NOTICE '  Loaded silver.erp_cust_az12 in % seconds', EXTRACT(SECOND FROM table_end_time - table_start_time_time);
        ...
        table_end_time := clock_timestamp();
        RAISE NOTICE '  Loaded silver.erp_loc_a101 in % seconds', EXTRACT(SECOND FROM table_end_time - table_start_time_time);
        ...
        table_end_time := clock_timestamp();
        RAISE NOTICE '  Loaded silver.erp_px_cat_g1v2 in % seconds', EXTRACT(SECOND FROM table_end_time - table_start_time);
